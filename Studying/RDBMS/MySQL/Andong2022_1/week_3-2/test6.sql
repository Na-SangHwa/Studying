...
-- C:\Program Files\MySQL\MySQL Server 8.0\bin  위치에서 cmd 창열기
...
insert into book(subject,price,year) values('HTM5',20000,'2022-05-18');
...
-- 콘솔창에서
update book set subject='JSP 20일 완성2' where num=3;

-- MySQL Workbench에서
update book set subject='JSP 마스터북2' where num=3;
commit;
-- -------------------------------------------------------------------------------------
-- ex3) 테이블생성과 자동값증가
drop table member;
...
-- [문제] idx가 1인 member의 비밀번호를 0000, 도메인을 aa.co.kr로 수정하시오
UPDATE member
SET userpwd = '0000', emaildomain = 'aa.co.kr'
WHERE idx = 1;

-- 오류 해결:  https://lightblog.tistory.com/193
...
alter table  member  rename to  emp;
